class View {
  ...
  renderPanel({ level, score, lines, nextPiece }) {
    ...
    this.context.fillText(`lines: ${lines}`, this.panelX, this.panelY + 25);
    this.context.fillText(`score: ${score}`, this.panelX, this.panelY + 50);
    this.context.fillText(`Next: `, this.panelX, this.panelY + 95);
